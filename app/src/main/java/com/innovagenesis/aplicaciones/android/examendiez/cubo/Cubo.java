package com.innovagenesis.aplicaciones.android.examendiez.cubo;
...
public class Cubo {
    ...
    public void cargarTextura(GL10 gl, Context context){
        ...
        InputStream istream = context.getResources().openRawResource(R.raw.textura2);
